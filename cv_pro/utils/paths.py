...
def handle_args_path(args: argparse.Namespace, default_ext: str = '.bin') -> None:
...
def get_files_in_root_dir(root_dir: Path, ext: str = '.bin'):
    paths = sorted(
...
def get_unique_filename(output_dir: Path, base_filename: str, ext: str) -> str:
    ...
    n = 1
    print(output_dir, base_filename)
